...
public class Main {
	...
	public static void main(String[] args) {
		...
		try {	
			...
			String sql2 = "insert into g_artists (name, a_type, a_year, debut, regdate)" + " values ('샘플','남성','2010년대','2010년',datetime('now','localtime'))";
			...
			String sql3 = "update g_artists set a_year = '2000년대' " + "where id=2 ;";
